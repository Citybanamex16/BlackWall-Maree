...
router.post('/api/orders/:id/accept', isAuth, isAdmin, adminControlador.postAcceptOrder)
router.post('/api/orders/:id/status', isAuth, isAdmin, adminControlador.postUpdateOrderStatus)

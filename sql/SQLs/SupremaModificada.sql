...
CREATE TABLE `orden_tiene_producto` (
  `id_orden_item`  int(11)        NOT NULL AUTO_INCREMENT,
  `ID_Orden`       varchar(10)    NOT NULL,
...
CREATE TABLE `detalle_orden_insumos` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_orden_item` (`id_orden_item`),
...
-- NOTA: PK compuesta eliminada. Ahora PK es id_orden_item AUTO_INCREMENT.
--       Índices ya declarados inline en el CREATE TABLE.
--
...
ALTER TABLE `orden_tiene_producto`
  MODIFY `id_orden_item` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `detalle_orden_insumos`
  ADD CONSTRAINT `detalle_orden_insumos_ibfk_1` FOREIGN KEY (`id_orden_item`)
      REFERENCES `orden_tiene_producto` (`id_orden_item`) ON DELETE CASCADE,
  ADD CONSTRAINT `detalle_orden_insumos_ibfk_2` FOREIGN KEY (`ID_Insumo`)
      REFERENCES `insumo` (`ID_Insumo`),
  ADD CONSTRAINT `detalle_orden_insumos_ibfk_3` FOREIGN KEY (`ID_Orden`)

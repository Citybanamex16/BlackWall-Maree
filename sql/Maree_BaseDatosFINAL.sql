...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 26, 2026 at 08:43 PM
...
CREATE TABLE `cliente` (
  `numero_telefonico_cliente` varchar(20) NOT NULL,
...
--
ALTER TABLE `cliente`
  ADD PRIMARY KEY (`numero_telefonico_cliente`,`Nombre_Royalty`);

--
-- Indexes for table `cliente_notifica_mensaje`
--
ALTER TABLE `cliente_notifica_mensaje`
  ADD PRIMARY KEY (`numero_telefonico_cliente`,`ID_Mensaje`),
...
--
ALTER TABLE `orden`
  ADD PRIMARY KEY (`ID_Orden`,`ID_Sucursal`,`numero_telefonico_cliente`),
  ADD KEY `ID_Sucursal` (`ID_Sucursal`),
  ADD KEY `numero_telefonico_cliente` (`numero_telefonico_cliente`) USING BTREE;
...
ALTER TABLE `cliente_notifica_mensaje`
  ...
  ADD CONSTRAINT `cliente_notifica_mensaje_ibfk_2` FOREIGN KEY (`numero_telefonico_cliente`) REFERENCES `cliente` (`numero_telefonico_cliente`);
...
ALTER TABLE `orden`
  ...
  ADD CONSTRAINT `orden_ibfk_2` FOREIGN KEY (`numero_telefonico_cliente`) REFERENCES `cliente` (`numero_telefonico_cliente`);
